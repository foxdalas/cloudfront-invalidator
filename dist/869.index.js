...
exports.modules = {
  /***/ 5869: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    const resolveWebIdentityCredentials = async (profile, options) =>
      Promise.all(
        /* import() */ [__webpack_require__.e(80), __webpack_require__.e(956)],
      )
    ...
    class LoginCredentialsFetcher {
      ...
      async refresh(token) {
        const { SigninClient, CreateOAuth2TokenCommand } =
          await __webpack_require__
            .e(/* import() */ 652)
            .then(__webpack_require__.t.bind(__webpack_require__, 6652, 19));
      ...
      async loadToken() {
        ...
        try {
          let tokenData;
          try {
            tokenData = await sharedIniFileLoader.readFile(tokenFilePath, {
      ...
      getTokenFilePath() {
        const directory =
          ...
          node_path.join(node_os.homedir(), ".aws", "login", "cache");
        const loginSessionBytes = Buffer.from(this.loginSession, "utf8");
        const loginSessionSha256 = node_crypto
          .createHash("sha256")
      ...
      async generateDpop(method = "POST", endpoint) {
        ...
        try {
          ...
          const asn1Signature = node_crypto.sign(
            "sha256",
            Buffer.from(message),
            privateKey,
          );
